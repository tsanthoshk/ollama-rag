### Local RAG Assistant Example

Welcome to the Local RAG Assistant Examples repository — a collection of educational examples built on top of large language models (LLMs). 

This repository was initially created as part of the blog post, [Build your own RAG and run it locally: Langchain + Ollama + Streamlit](https://blog.duy.dev/build-your-own-rag-and-run-them-locally/).
